...
### 1. **Регистрация, авторизация и смена пароля** (Login Page, Registration Page, ResetPassword Page)
- Пользователь заполняет форму регистрации.
- Пользователь вводит логин и пароль.
- При желании сбрасывает пароль.
- После успешного входа его перенаправляют в раздел входящих писем **Inbox**.
- Защита маршрутов реализована через **CanActivateFn**.
  
**Регистрация:**

![image](https://github.com/user-attachments/assets/e013807c-d495-4dd9-ae7b-5cab64897200)
...
![image](https://github.com/user-attachments/assets/4c130091-939a-4559-9dd8-d700f7543e45)

В связи с использованием локального хранилища, код подтверждения не отправляется на номер телефона, а выводится в консоль (при наличии соответствующего номера телефона).

![image](https://github.com/user-attachments/assets/2df7259f-4a62-453c-a6a3-afeb4a9d9647)
